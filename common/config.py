...
# NOTE: asymmetric -- Cb is heavily subsampled horizontally (4x1), Cr stays
# at full resolution like Y (4x1 too). Verified empirically via the SOF
# marker of the produced JPEG, not assumed from the cjpeg docs.
