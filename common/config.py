...
BRANCH_NAME = "algo/jpeg-4x2x2"
RESULTS_CSV = os.path.join(RESULTS_DIR, "resultats_jpeg-4x2x2.csv")
...
# algo/jpeg-4x2x2: identical to algo/jpeg-baseline except for chroma
# subsampling -- JPEG standard libjpeg IJG v9e, quality Q75, 4:2:2.
JPEG_QUALITY = 75
JPEG_SAMPLE_FACTORS = "2x1,1x1,1x1"  # cjpeg -sample argument -> 4:2:2
